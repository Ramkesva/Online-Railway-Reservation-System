...
String username = userDetails.getUsername();
			int seats = restTemplate.postForObject("http://BookingDetails/booking/bookticket/"+username, book, Integer.class);
//			return seats+"";
			if(seats>0)
			{
		...
		public String cancelticket(@PathVariable String userId)
		{
			restTemplate.delete("http://BookingDetails/booking/cancelticket/{userId}",userId);
			return "Train Ticket with "+userId+" cancelled Succesfully";
		}
